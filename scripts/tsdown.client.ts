 ...
 *
 * Adapted from the dsh repository's packages/client/tsdown.client.ts for the
 * standalone rollback plugin; the external list lives in
 * ./client-externals.ts.
 */
...
import { CLIENT_EXTERNALS } from './client-externals.ts'
 ...
 * @param options - phase placement and lib overrides.
 * @returns ENV-selected tsdown config for the current build face.
 */
export function clientBundle(
  id: string,
  libEntry: readonly string[],
  options: { readonly lib?: UserConfig } = {},
...
function clientConfig(id: string, entry: string): UserConfig {
  return {
    ...
    // keeps the dev-branch semantics; artifacts default to production.
    define: {
